...
import 'package:wallet/config/payment_configurations.dart';
...
class _SendMoneyState extends State<SendMoney> {
  String googlePayConfig = defaultGooglePay;
  var amountmoney = TextEditingController(text: "0.00");
                ...
                FadeInUp(
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      ...
                      onTap: () {
                        setState(() {
                          if (amountmoney.text == "0.00") {
                            amountmoney.text = "";
                          } else {
                            amountmoney.text =
                                amountmoney.text.replaceAll(RegExp(r'.00'), '');
                          }
                        });
                      },
